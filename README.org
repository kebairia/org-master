...
* Dependencies
** Emacs packages
- you can use the any emacs's package manager you want, but i prefer using [[https://github.com/raxod502/straight.el][straight.el]].
...
3. add *org*, *org-ref* and *latex* configuration to your init.el, (this is the emacs's configuration file), you can use my own [[id:emacs-config][configuration]]
...
* Building 
- use ~make build~ to build the .pdf file, ~make clean~ to clean the temp files, ~make watch~ to sync your modification with the preview using your pdf viewr
  you can specify your pdf viewr application in the [[file:latexmkrc::11]] file
